export const translations = {
  en: {
    ...
    addData: "Add Data",
    backToBerryList: "BACK TO BERRY LIST",
  ...
  id: {
    ...
    addData: "Tambah Data",
    backToBerryList: "KEMBALI KE DAFTAR",
